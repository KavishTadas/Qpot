...
public class Zip_Folder  extends Loop_Base{
	
    public static String sourcePath = "E:\\Qpot\\Report"; // Replace with the path to your file or folder
    public static String zipFilePath = "E:\\Qpot\\Report_zipped.zip"; // Replace with the desired destination ZIP file path
